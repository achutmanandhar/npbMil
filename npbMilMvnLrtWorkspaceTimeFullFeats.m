...
% addpath('C:\Users\manandhar\research\matlabStuff\Research\vbDpMnMil');
% addpath('C:\Users\manandhar\research\matlabStuff\Research\bnpMil');
addpath('C:\Users\manandhar\research\matlabStuff\Research\milBenchmarkTime\');

dataSetName(1).name = 'musk1';
dataSetName(2).name = 'musk2';
dataSetName(3).name = 'elephant';
dataSetName(4).name = 'tiger';
dataSetName(5).name = 'fox';
dataSetName(6).name = 'trec1';
dataSetName(7).name = 'trec2';

dataFileName(1).name = 'musk1Norm';
dataFileName(2).name = 'musk2Norm';
dataFileName(3).name = 'elephantNonZeroFeatures';
dataFileName(4).name = 'tigerNonZeroFeatures';
dataFileName(5).name = 'foxNonZeroFeatures';
dataFileName(6).name = 'trec1NonZeroFeatures';
dataFileName(7).name = 'trec2NonZeroFeatures';

algName = 'vbMil';

pathName = 'C:\Users\manandhar\research\matlabStuffData\Research\milBenchmarkTimeMissing\fullFeatures\';

for nDataSet=2%:5%length(dataSetName)
    
    fprintf('\n Dataset %d...\n',nDataSet);

    pathData = 'C:\Users\manandhar\research\matlabStuffData\Research\milDatasets\';
    load([pathData,dataFileName(nDataSet).name]);
...
%         myTestFun           = @classifyVbDpMnMilLlrtTest;
        ...
        [yOut,~,~,timeTrainFolds, timeTestFolds] = nValMilTimePP2(bags,numOfFolds,myTrainFun,myTestFun,myOptions); % leave-one-bag-out xVal 
